...
const popoverWidth = computed(() => '498px')
const popoverContentMaxHeight = computed(() => '515px')
        ...
        <n-scrollbar v-else trigger="none" :style="{ maxHeight: popoverContentMaxHeight }">
          <div class="map-container">
            <div
              ...
              class="map-panel"
            >
              <div class="map-title">{{ entry.map.name_zh }}</div>
                ...
                <div class="markers-overlay">
                  <template v-for="(aetheryte, idx) in entry.map.aetherytes" :key="`aeth-${entry.placeId}-${idx}`">
                    ...
                    >
                      ...
                      <div class="tooltip">{{ aetheryte.name_zh }}</div>
                    </n-tooltip>
                  </template>
